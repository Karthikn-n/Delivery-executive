              ...
              children: [
                ...
                : Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Text('Subscribed Product', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),),
                    ),
                ...
                ? Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        padding: EdgeInsets.fromLTRB(20, 10, 20, 10),
                        child: Text('Ordered Product', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),),
                      ),
                ...
                const Padding(
                  ...
                  child: Text('All Products', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),),
                ),
                // All products 
                SizedBox(
                  height: provider.allProducts.length * 92,
                  child: ListView.builder(
                    physics: const NeverScrollableScrollPhysics(),
